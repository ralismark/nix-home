self: super: {
  ...
  droid-fonts = self.callPackage ./droid-fonts {};

  # based on <https://gitlab.manjaro.org/packages/community/themes/adapta-manjaro-themes/-/blob/master/PKGBUILD>
  ...
  # adapta-gtk-theme = super.adapta-gtk-theme.overrideAttrs (final: prev: {
  #   configureFlags = [
  #     "--enable-gtk_next"
  #     "--disable-gnome"
  #     "--disable-cinnamon"
  ...
  #       ./wm/openbox-3/themerc \
  #       ./wm/openbox-3/themerc-nokto \
  #       ./wm/xfwm4/themerc -type f -print |\
  #       xargs sed -i -e 's/#2196F3/#38a8a3/Ig' -e 's/#03A9f4/#299984/Ig'
  #   '';
  #   postInstall = ''
  #     ${prev.postInstall or ""}
